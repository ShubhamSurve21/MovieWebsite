  ...
  return (
    <div className="bg-white rounded-xl border border-tmdb-blue/10 shadow-md hover:shadow-xl transition-shadow duration-200 overflow-hidden group cursor-pointer relative hover:-translate-y-1 hover:scale-105">
      <div className="relative">
        ...
        />
        <div className="absolute top-2 right-2 bg-tmdb-blue text-white px-2 py-1 rounded text-xs font-bold opacity-90">
          {person.known_for_department}
        </div>
      </div>
      <div className="p-4">
        <h3 className="font-extrabold text-lg text-tmdb-dark mb-1 truncate">{person.name}</h3>
        <p className="text-gray-600 text-sm mb-2 truncate">Popularity: {person.popularity}</p>
